export default function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-red-50 py-4 sm:py-12 px-2 sm:px-4">
      <div className="max-w-5xl mx-auto">
        {/* Decorative Border Container */}
        <div className="relative bg-white shadow-2xl rounded-lg overflow-hidden">
          {/* Golden Border */}
          <div className="absolute inset-0 border-4 sm:border-8 border-amber-400 rounded-lg pointer-events-none"></div>
          <div className="absolute inset-2 sm:inset-3 border-2 sm:border-4 border-blue-700 rounded-lg pointer-events-none"></div>
          ...
          <div className="relative z-10 p-4 sm:p-8 lg:p-12">
            {/* Header */}
            <div className="text-center mb-8 sm:mb-12 bg-gradient-to-r from-red-50 to-orange-50 py-4 sm:py-8 px-3 sm:px-6 rounded-lg shadow-lg border-2 sm:border-4 border-red-700">
              <div className="text-2xl sm:text-3xl lg:text-4xl font-bold text-red-800 mb-2 sm:mb-3" style={{ fontFamily: 'Georgia, serif' }}>
                ॥ श्री गणेशाय नमः ॥
              </div>
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-blue-700 mb-1 sm:mb-2">
                विवाह परिचय पत्र
              </div>
              <div className="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-900">
                MARRIAGE BIODATA
              </div>
              <div className="mt-3 sm:mt-4 h-1 w-32 sm:w-48 mx-auto bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400"></div>
            </div>

            {/* Personal Details with Photo */}
            <div className="mb-8 sm:mb-10">
              <div className="bg-blue-700 text-white text-center py-2 sm:py-3 rounded-t-lg shadow-md">
                <h2 className="text-lg sm:text-xl font-bold">व्यक्तिगत विवरण / PERSONAL DETAILS</h2>
              </div>
            ...
            <div className="mb-8 sm:mb-10">
              <div className="bg-blue-700 text-white text-center py-2 sm:py-3 rounded-t-lg shadow-md">
                <h2 className="text-lg sm:text-xl font-bold">शैक्षणिक योग्यता / EDUCATIONAL QUALIFICATION</h2>
              </div>
              <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 sm:p-6 rounded-b-lg border-2 sm:border-4 border-blue-600">
                <div className="space-y-2 sm:space-y-3">
                  <EducationRow
                    degree="PhD (Pursuing)"
            ...
            <div className="mb-8 sm:mb-10">
              <div className="bg-blue-700 text-white text-center py-2 sm:py-3 rounded-t-lg shadow-md">
                <h2 className="text-lg sm:text-xl font-bold">पारिवारिक विवरण / FAMILY BACKGROUND</h2>
              </div>
              <div className="bg-gradient-to-br from-emerald-50 to-green-50 p-4 sm:p-6 rounded-b-lg border-2 sm:border-4 border-emerald-600">
                ...
                <div className="mt-4 sm:mt-6 pt-4 sm:pt-6 border-t-2 border-emerald-300">
            ...
            <div className="mb-8 sm:mb-10">
              <div className="bg-blue-700 text-white text-center py-2 sm:py-3 rounded-t-lg shadow-md">
                <h2 className="text-lg sm:text-xl font-bold">संपर्क सूत्र / CONTACT DETAILS</h2>
              </div>
              <div className="bg-gradient-to-br from-amber-50 to-yellow-50 p-4 sm:p-6 rounded-b-lg border-2 sm:border-4 border-amber-500">
                <div className="space-y-2 sm:space-y-3">
                  <ContactRow
                    label="Address"
            ...
            <div className="text-center">
              <div className="h-1 w-32 sm:w-64 mx-auto bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 mb-4 sm:mb-6"></div>
              <div className="bg-gradient-to-r from-blue-50 to-indigo-50 py-4 sm:py-6 px-4 sm:px-8 rounded-lg border-2 sm:border-4 border-blue-700 shadow-lg">
                <p className="text-lg sm:text-xl font-bold text-red-800 mb-2">
                  हम अपने सुपुत्र के लिए उच्च शिक्षित, संस्कारी परिवार से
                </p>
                <p className="text-lg sm:text-xl font-bold text-red-800 mb-2 sm:mb-3">
                  उपयुक्त वधू की तलाश कर रहे हैं
                </p>
                <p className="text-base sm:text-lg italic text-blue-900">
                  We seek a suitable, well-educated bride from a cultured family
                </p>
              </div>
              <div className="h-1 w-32 sm:w-64 mx-auto bg-gradient-to-r from-amber-400 via-amber-500 to-amber-400 mt-4 sm:mt-6"></div>
            </div>
          </div>
        </div>
      </div>
...
function DetailRow({ label, value, bold = false }: { label: string; value: string; bold?: boolean }) {
  return (
    <div className="flex flex-col sm:flex-row">
      <span className="font-bold text-blue-900 sm:w-32 lg:w-40">{label}</span>
      <span className="hidden sm:inline mx-2">:</span>
      <span className={`${bold ? "font-bold text-gray-900" : "text-gray-800"} break-words`}>{value}</span>
    </div>
  );
}
...
function EducationRow({ degree, details }: { degree: string; details: string }) {
  return (
    <div className="flex flex-col sm:flex-row">
      <span className="font-bold text-red-800 sm:w-40 lg:w-48">{degree}</span>
      <span className="hidden sm:inline mx-2">:</span>
      <span className="text-gray-800 font-semibold break-words">{details}</span>
    </div>
  );
}
...
function FamilyMember({ relation, name, occupation, mobile }: { relation: string; name: string; occupation?: string; mobile?: string }) {
  return (
    <div className="bg-white p-2 sm:p-3 rounded-lg shadow-sm border-l-4 border-red-600">
      <p className="font-bold text-red-800 text-xs sm:text-sm">{relation}:</p>
      <p className="font-bold text-gray-900 text-sm sm:text-base break-words">{name}</p>
      {occupation && <p className="text-xs sm:text-sm italic text-gray-700 mt-1 break-words">{occupation}</p>}
      {mobile && <p className="text-xs sm:text-sm font-semibold text-blue-900 mt-1">{mobile}</p>}
    </div>
  );
}
...
function ContactRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col sm:flex-row">
      <span className="font-bold text-blue-900 sm:w-40 lg:w-48">{label}</span>
      <span className="hidden sm:inline mx-2">:</span>
